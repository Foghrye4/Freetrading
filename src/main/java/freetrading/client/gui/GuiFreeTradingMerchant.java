...
public class GuiFreeTradingMerchant extends GuiScreen {
	...
	private final GuiInventorySlot[] merchantInventorySlots = new GuiInventorySlot[MERCHANT_SLOT_NUM];
	private final GuiInventorySlot[] playerInventorySlots = new GuiInventorySlot[PLAYER_SLOT_NUM];
	...
	private GuiInventorySlot getSlotFromPos(int x, int y) {
