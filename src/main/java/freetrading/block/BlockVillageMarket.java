...
public class BlockVillageMarket extends Block implements ITileEntityProvider {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (te instanceof TileEntityVillageMarket && playerIn instanceof EntityPlayerMP)
			((TileEntityVillageMarket) te).tryTrade((EntityPlayerMP) playerIn);
		return true;
	}
